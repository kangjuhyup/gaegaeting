...
import { MatchFeedLikeV1Payload, MatchPairCreatedV1Payload, NotificationFcmSendV1Payload, ChatRoomCreatedV1Payload } from "./payload";
...
export interface TopicPayloadMap {
    ...
    [Topics.MATCH_PAIR_CREATED_V1]: MatchPairCreatedV1Payload;
    [Topics.CHAT_ROOM_CREATED_V1]: ChatRoomCreatedV1Payload;
