...
jest.unstable_mockModule('@core/kafka', () => {
  return {
    KafkaProducerService: class MockKafkaProducerService {},
    KafkaProducerModule: {
...
const { LikeInfrastructureModule } = await import(
  '#app/like/infrastructure/like.infrastructure.module'
);
