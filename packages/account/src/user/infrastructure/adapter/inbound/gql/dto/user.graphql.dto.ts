import { UserProfileEntity, type IUserProfile } from '#app/user/domain/model/user-profile';
...
import { CreateUserProfileInput, UpdateUserProfileInput } from './user.input.js';
import { UserProfile } from './user.type.js';
import { UserGenderGql, UserRegionGql, UserStatusGql } from './user.enum.js';
