...
export function getEntitiesBySchema(schema: DatabaseSchema[]): any[] {
  const entityMap = {
    ...
    [DatabaseSchema.USER]: [UserProfileOrmEntity, PetProfileOrmEntity, UserAttachmentOrmEntity, PetAttachmentOrmEntity, ItemWalletOrmEntity, ItemLotOrmEntity, ItemLedgerOrmEntity],
