...
import { createRedisClients } from '../redis.factory.js';
import { REDLOCK, REDLOCK_CLIENTS, REDLOCK_OPTIONS, type RedlockModuleAsyncOptions, type RedlockModuleOptions } from './lock.type.js';
